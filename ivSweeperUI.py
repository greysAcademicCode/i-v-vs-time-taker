...
class Ui_IVSweeper(object):
    def setupUi(self, IVSweeper):
        ...
        self.findButton = QtGui.QPushButton(self.addressGroup)
        self.findButton.setGeometry(QtCore.QRect(270, 20, 161, 27))
        self.findButton.setAutoDefault(False)
        self.findButton.setDefault(True)
        self.findButton.setObjectName(_fromUtf8("findButton"))
        self.addressField = QtGui.QLineEdit(self.addressGroup)
        self.addressField.setGeometry(QtCore.QRect(10, 20, 241, 27))
        self.addressField.setToolTip(_fromUtf8(""))
        ...
        self.fourwireRadio.setGeometry(QtCore.QRect(120, 20, 91, 22))
        self.fourwireRadio.setObjectName(_fromUtf8("fourwireRadio"))
        self.sweepGroup = QtGui.QGroupBox(self.centralwidget)
        self.sweepGroup.setGeometry(QtCore.QRect(10, 130, 391, 131))
        ...
        self.startSpin.setGeometry(QtCore.QRect(50, 20, 101, 27))
        ...
        self.totalPointsSpin.setGeometry(QtCore.QRect(240, 20, 71, 27))
        ...
        self.label_3.setGeometry(QtCore.QRect(160, 30, 81, 17))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.label_6 = QtGui.QLabel(self.sweepGroup)
        self.label_6.setGeometry(QtCore.QRect(160, 60, 71, 17))
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.totalTimeSpin = QtGui.QSpinBox(self.sweepGroup)
        self.totalTimeSpin.setGeometry(QtCore.QRect(240, 50, 71, 27))
        self.totalTimeSpin.setMinimum(2)
        self.totalTimeSpin.setMaximum(999999999)
        self.totalTimeSpin.setProperty("value", 2)
        self.totalTimeSpin.setObjectName(_fromUtf8("totalTimeSpin"))
        self.autoAdvance = QtGui.QCheckBox(self.sweepGroup)
        self.autoAdvance.setEnabled(False)
        self.autoAdvance.setGeometry(QtCore.QRect(180, 90, 161, 22))
        self.autoAdvance.setObjectName(_fromUtf8("autoAdvance"))
        self.deltaStep = QtGui.QLabel(self.sweepGroup)
        self.deltaStep.setGeometry(QtCore.QRect(320, 30, 71, 16))
        self.deltaStep.setObjectName(_fromUtf8("deltaStep"))
        self.deltaTime = QtGui.QLabel(self.sweepGroup)
        self.deltaTime.setGeometry(QtCore.QRect(320, 60, 71, 16))
        self.deltaTime.setObjectName(_fromUtf8("deltaTime"))
        self.daqGroup = QtGui.QGroupBox(self.centralwidget)
        self.daqGroup.setGeometry(QtCore.QRect(420, 130, 221, 131))
        self.daqGroup.setObjectName(_fromUtf8("daqGroup"))
        self.zeroCheck = QtGui.QCheckBox(self.daqGroup)
        self.zeroCheck.setGeometry(QtCore.QRect(10, 30, 93, 22))
        self.zeroCheck.setObjectName(_fromUtf8("zeroCheck"))
        self.speedCombo = QtGui.QComboBox(self.daqGroup)
        self.speedCombo.setGeometry(QtCore.QRect(70, 60, 141, 27))
        ...
        self.label_7.setGeometry(QtCore.QRect(10, 70, 62, 17))
        self.label_7.setObjectName(_fromUtf8("label_7"))
        self.averageSpin = QtGui.QSpinBox(self.daqGroup)
        self.averageSpin.setEnabled(True)
        self.averageSpin.setGeometry(QtCore.QRect(130, 90, 55, 27))
        ...
        self.sourceVRadio.setGeometry(QtCore.QRect(10, 20, 81, 22))
        ...
        self.sweepContinuallyGroup.setGeometry(QtCore.QRect(10, 270, 291, 51))
        ...
        self.label_4.setGeometry(QtCore.QRect(10, 20, 151, 17))
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.scanRecoverySpin = QtGui.QDoubleSpinBox(self.sweepContinuallyGroup)
        self.scanRecoverySpin.setGeometry(QtCore.QRect(170, 10, 101, 27))
    ...
    def retranslateUi(self, IVSweeper):
        ...
        self.addressGroup.setTitle(_translate("IVSweeper", "Instrument Address", None))
        self.findButton.setText(_translate("IVSweeper", "Discover Instrument...", None))
        self.sweepButton.setText(_translate("IVSweeper", "Start Sweep", None))
        self.terminalsGroup.setTitle(_translate("IVSweeper", "Which Terminals", None))
        ...
        self.label_3.setText(_translate("IVSweeper", "Total Points:", None))
        self.label_6.setText(_translate("IVSweeper", "Total Time:", None))
        self.totalTimeSpin.setSuffix(_translate("IVSweeper", " s", None))
        ...
        self.deltaTime.setText(_translate("IVSweeper", "Δ=20 ms", None))
        ...
        self.complianceGroup.setTitle(_translate("IVSweeper", "Compliance", None))
        ...
        self.modeGroup.setTitle(_translate("IVSweeper", "Sweep Type", None))
        ...
        self.sweepContinuallyGroup.setTitle(_translate("IVSweeper", "Sweep Continually", None))
